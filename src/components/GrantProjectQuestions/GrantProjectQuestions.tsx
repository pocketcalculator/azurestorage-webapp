...
const Question: React.FC<QuestionProps> = ({ questionText, onChange, value }) => {
  ...
  <div>
    {currentQuestionIndex > 0 && (
      <div className="previous-question w-72 border-2 border-gray-100 bg-gray-100 rounded p-4 mb-8">
        <label className="text-gray-400">{questions[currentQuestionIndex - 1]}</label>
        <p className="text-gray-400">{responses[currentQuestionIndex - 1]}</p>
      </div>
    )}
